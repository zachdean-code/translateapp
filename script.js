...
function getGoalValue() {
  ...
  return map[raw] || "translate accurately";
}
...
function applySiteLanguage(lang) {
  ...
  if (isSpanish) {
    ...
    safeTextBySelector(".description", "Traducción con sensibilidad dialectal y claridad cultural");
    ...
    safeTextBySelector('label[for="contextToggle"]', "Modo de contexto mejorado");
  } else {
    ...
    safeTextBySelector(".description", "Dialect-aware translation and cultural clarity");
    ...
    safeTextBySelector('label[for="contextToggle"]', "Enhanced Context Mode");
  }
