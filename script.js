...
function applyLanguage(lang) {
  ...
  safeText("keepDetectedButton", t("copyButton", lang));
  safeText("changeDetectedButton", t("copyButton", lang));
  ...
  if (userInput) userInput.placeholder = t("inputPlaceholder", lang);
  if (output) output.placeholder = t("outputPlaceholder", lang);
  if (pronunciation) pronunciation.placeholder = t("pronunciationPlaceholder", lang);
  if (targetSearch) targetSearch.placeholder = t("targetSearchPlaceholder", lang);
  if (detectedSearch) detectedSearch.placeholder = t("targetSearchPlaceholder", lang);
...
function spanishToEnglishPhonetics(text) {
  ...
  return words.map((raw) => {
    ...
    return transformed.toUpperCase() + punctuation;
  }).join(" ");
}
...
async function translateText() {
  ...
  try {
    ...
    const translated = data.output || data.translation || "";
